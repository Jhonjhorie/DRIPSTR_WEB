      ...
      return (
        <div className="mt-2 p-3 bg-yellow-50 border border-yellow-200 rounded-md">
          <div className="flex items-start gap-2">
            ...
            <div>
              <h4 className="text-sm font-medium text-yellow-800">Return Instructions</h4>
              <p className="text-sm text-yellow-700 mt-1">
                Your refund has been approved. Please return the parcel to the nearest DRIPSTR Outlet 
                within 7 days to complete the refund process. Bring your order ID #{order.id} for reference.
              </p>
            </div>
          </div>
        </div>
