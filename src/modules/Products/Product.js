...
function Product() {
  ...
  return (
    <div className="w-full relative pb-16 items-start justify-start bg-slate-300 flex flex-col gap-2 px-2 lg:px-8 ">
      {loginDialog && (
        <AuthModal
          isOpen={loginDialog}
      ...
      <div className="justify-start w-full">
        <div className="max-w-[120rem] flex items-start justify-center gap-2 md:gap-8 p-4 hero-content flex-col h-full w-full md:flex-row">
          <div className="flex flex-col w-full">
            <div className="carousel w-full h-[40vh] md:h-[70vh] bg-slate-50 z-10 rounded-md overflow-y-hidden">
              {imagePreview != null ? (
          ...
          {/* Product Details */}
          <div className="flex flex-col justify-start md:justify-between gap-4  z-10 lg:items-end md:min-h-[70vh] h-full w-full ">
            <div className="flex flex-col w-full gap-1">
              <div className="flex justify-between items-center">
                <h1 className="text-3xl md:text-4xl font-bold text-secondary-color p-1 pb-2 rounded-t-md">
                  {item.item_Name}
                </h1>
                {isLoggedIn && (
              ...
              <div className="h-0.5  w-full bg-primary-color"></div>
              <div className="flex flex-col justify-between gap-4">
                <div className="flex justify-between gap-2 items-center">
                  <div className="flex items-center gap-2">
                    <p className="text-xs md:text-sm font-medium">Shop:</p>
                    <button
                    ...
                    <div className="flex items-end justify-center gap-2">
                      ...
                      <div className="items-center flex flex-col justify-center">
                        <div className="flex justify-end pl-2">
                          ...
                          <h2 className="text-4xl md:text-5xl font-bold text-primary-color">
                            {selectedSize
                              ? item?.discount > 0
                                ? (
