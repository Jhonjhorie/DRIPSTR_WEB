...
const Orders = () => {
  ...
  const tabs = ["All", "To Pay", "To Ship", "To Receive", "Received (32)", "Cancellations", "Reviews"];
        ...
        <div className="p-4 bg-slate-200 min-h-screen">
          ...
          <div className="group relative flex items-center bg-gray-50 rounded-md my-2 ">
            ...
            <input
              type="text"
              placeholder="Search..."
              className="flex-1 text-black bg-transparent outline-none pl-1"
            />
          </div>
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                <p className="text-gray-800 font-medium">
                  [LIXIAOJU] For Dell Latitude 3410 3510 E3510 E3410 Laptop
                  Charging Flex Cable 07DM5H 0N8R4T DC Power Jack cable
                </p>
