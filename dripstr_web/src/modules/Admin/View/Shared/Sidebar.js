...
function Sidebar() {
  ...
  const SidebarItem = ({ icon, label, to }) => (
    <NavLink
      ...
      className={({ isActive }) =>
        `flex items-center w-full p-3 leading-tight transition-all rounded-2xl outline-none text-start duration-500 hover:scale-125 hover:bg-white hover:text-black focus:bg-white focus:text-black ${isActive ? "bg-white text-black" : ""
        }`
      }
    >
