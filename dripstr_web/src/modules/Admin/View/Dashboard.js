...
const statCards = [
  { icon: <UserGroupIcon className="w-6 h-6" />, value: "63459", label: "Customer" },
  { icon: <BuildingStorefrontIcon className="w-6 h-6" />, value: "69", label: "Merchant" },
  { icon: <PencilIcon className="w-6 h-6" />, value: "69", label: "Designer" },
  { icon: <UsersIcon className="w-6 h-6" />, value: "69", label: "Overall Users" },
];
        ...
        <div className="h-3/6 m-1 flex flex-col">
          <div className="bg-slate-900 2xl:w-4/6 sm:w-full h-full w-3/4 m-4 rounded-3xl p-2 cursor-default">
            <div className="flex h-full flex-col">
              ...
              {/* Add content here */}
              <div className="flex-grow text-white">Content goes here...</div>
            </div>
          </div>
        </div>
