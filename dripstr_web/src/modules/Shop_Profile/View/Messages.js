...
const CustnameData = [
    { id: 1, photo: cust1, order: sample2 , name: 'Erina Mae', message: 'Just order an Item.', status: 'sent', orderRating: 'to rate', timeSent: '2m ago', reply: ' Thank you for purchasing on our store.', follow: 'Followers'   },
    { id: 2, photo: cust2, order: sample3 ,name: 'Paolo', message: 'Just order an Item.', status: 'read', timeSent: '1h ago',  orderRating: '4', follow: 'Followers' ,
    message2: 'The product is good<3' ,
    reply: ' Thank you for purchasing on our store.'   },
    { id: 3, photo: cust3, order: sample1 ,name: 'Queen', message: 'Just order an Item.', status: 'sent', timeSent: '1m ago', orderRating: 'to rate',  reply: ' Thank you for purchasing on our store.', follow: 'Customer' }
]
        ...
        <div className='w-full  h-full bg-slate-100 flex'>
            ...
            <div className={`w-full relative z-10 bg-violet-100 h-full flex ${isClosing ? 'fade-out' : 'fade-in'}`}>
                            ...
                            {selectedUser.message  && (
                                <div className="chat chat-start">
                                    <div className='mb-1 ml-14'>
                                        ...
                                        {selectedUser.order && (
                                            <div className='h-24 w-24 bg-slate-100 shadow-md shadow-slate-600 rounded-md border-[1px] border-primary-color
                                             '>
                                                <img
                ...
                <div className='w-full h-auto p-2 place-items-center '>
                    ...
                    <div className='mt-2 text-white font-semibold text-sm'>{selectedUser.follow}</div>
                    <div className='border-t-2 border-slate-600 w-full mt-5'>            
                    </div>     
                        ...
                        <div className='h-[300px] w-full pl-2 pt-2 bg-slate-200 rounded-md shadow-inner shadow-black overflow-hidden overflow-y-scroll'>
                            <div className='bg-sky-50 h-auto p-2 place-items-center shadow-md w-full rounded-sm hover:bg-primary-color duration-300 flex gap-2'> 
                                ...
                                <div className="text-slate-800 place-items-center flex gap-2">
                                    ...
                                    <box-icon 
                                    type="solid" 
                                    color={selectedUser.orderRating === 'to rate' ? '#FFFFFF' : '#EB8317'} 
                                    name="star"
                                    ></box-icon>
                                </div>
                                )}
